...
<head>
    ...
    <title>RegistroTrabajador</title>
    <!-- Bootstrap CSS -->
    ...
    <div class="containerDos">
        <div class="row">
            ...
            <div class="col-lg-12 "> <!-- Cambiado a text-left para alinear el texto a la izquierda -->
                <h2>Registro</h2>
                <h5>¡Estamos encantados de tenerte por aquí!</h5> 
                <h5>Recuerda, toda la información personal proporcionada, no será publicada, será completamente confidencial. </h5><!-- Subtítulo agregado -->
            </div>
        </div>
        <br>
        <div class="row">
            <div class="contenidoUno col-lg-6">
                <form method="POST" action="{{route('validar-registro-t')}}">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="campo9" placeholder="Nombre">
                    </div>
                </form>
            </form>
        </div>
        <div class="contenidoDos col-lg-6">
            <form>
                    <div class="mb-3">
                        <label for="campo2" class="form-label"></label>
                        <input type="text" class="form-control" id="campo2" placeholder="Cargo">
                    </div>
                    <div class="mb-3">
                        <label for="campo4" class="form-label"></label>
                        <input type="text" class="form-control" id="campo4" placeholder="Identificación">
                    </div>
                    <div class="mb-3">
